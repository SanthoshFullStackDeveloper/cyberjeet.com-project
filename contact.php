...
<body style="background-image: url(assets/img/background/wall.jpg);" class="slides chain simplifiedMobile animated">
    ...
    <nav class="navbar navbar-expand-lg  navbar-light sticky-top" >
        <div class="container-fluid">
         <a class="navbar-brand" href="#"><img
          src="assets/img/cyberjeet.png"
          alt=""
          class="logo"
          style="padding-top: 12px; height: 70px; width: 130px"/>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
         <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-baseline" style="letter-spacing: 1.4px; font-family: system-ui,  sans-serif;">

                    <!---------------------------------Home start--------------------------------->

                    <li id="link" class="nav-item" style="padding: 8px;"> 
                    ...
                    <li id="link" class="nav-item ps-4" style="padding: 8px;">
                        <a class="nav-link active" aria-current="page" href="about.html" style="color: white;">
                          <i class="bi bi-file-earmark-person-fill"></i> About Us</a>
        </li>
         ...
         <li id="link" class="nav-item ps-4" style="padding: 8px;">
          <a class="nav-link active" aria-current="page" href="services.html" style="color: white;"
            ><i class="bi bi-person-fill"></i> Services</a
          >
        </li>
        ...
        <li id="link" class="nav-item ps-4" style="padding: 8px;">
          <a class="nav-link active" aria-current="page" href="industries.html" style="color: white;"
            ><i class="bi bi-building-fill"></i> Industries</a
          >
        </li>

        <li id="link" class="nav-item ps-4" style="padding: 8px;">
          <a class="nav-link active" aria-current="page" href="career.html" style="color: white;"
            > <i class="bi bi-briefcase-fill"></i> Career </a>
        </li>

        <li id="link" class="nav-item ps-4" style="padding: 8px;">
          <a class="nav-link active nav-link " aria-current="page" href="partner.html" style="color: white;"
          >        <circle cx="20" cy="16" r="6"/>
          <i class="bi bi-people-fill"></i> Partners
                    ...
                    <li id="link" class="nav-item ps-4" style="padding: 8px;">
                        <a class="nav-link active" aria-current="page" href="contact.php" style="color: white;"> 
                        <i class="bi bi-person-lines-fill"></i> Contact Us</a>
                    </li>

         <!---------------------------------contact end--------------------------------->
         <li id="link" class="nav-item ps-4" style="padding: 8px;">
          <a class="nav-link active" aria-current="page" href="blog.html" style="color: white;"> 
          <i class="bi bi-hdd-rack-fill"></i> Blog</a>
         </li>
      </ul>
    </div>
  </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // this block of code will store the information
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="name form-control border-0" id="name" placeholder="Your Name" name="Name" style="height: 65px; border: 1px solid rgb(0, 0, 0); font-size: 18px; color:white; background-color: rgba(255, 165, 0, 0.12);" required>
                                        <label for="name" style="font-size:16px;font-weight:bold;">Your Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="email form-control border-0" id="email" placeholder="Your Email" name="Email" style="height: 65px;font-size: 18px; color:white; border: 1px solid white; background: rgba(255, 165, 0, 0.12);"required>
                                        <label for="email" style="font-size:16px;font-weight:bold;">Your Email</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                  <div class="form-floating">
                                    <input type="text" class="subject form-control border-0" id="subject" name="Subject" placeholder="Subject" style="font-size: 18px; color:white;height: 65px; border: 1px solid white; background: rgba(255, 165, 0, 0.12);" required>
                                    <label for="subject" style="font-size:16px;font-weight:bold;">Subject</label>
                                </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="message form-control border-0" placeholder="Leave a message here" id="message" name="Message" style="height:160px; text-align: right; font-size: 18px; color:white; background: rgba(255, 165, 0, 0.12);" required></textarea>
                                        <label for="message" style="font-size:16px;font-weight:bold;">Message</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="btn w-100 py-3"  name="send"  type="submit" style="height: 50px; background-color: #d37506; color: white;"><h4 style="margin-top: 4px;">Send Message</h4></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<!-- 
    ...
    function sendWhatsapp(){
      ...
      var url = "https://wa.me/" + phoneNumber + "?text=" 
          ...
          + "The accuracy of this information is indeed verified.";
 ...
 -->
    <div
      class="background"
      style="background-image: url(assets/img/background/back9.jpg)"
    ></div>
  </section>
    <!--contact end-->
    ...
    <section class="slide fade-6 kenBurns">
      <div class="content">
        <div class="container">
          <!-- <img src="assets/img/cyberjeet.png" alt="" style="height: 70px; width: 140px; margin-right: 1200px; margin-top: 50px;"> -->
          <h1
            class="huge ae-1 margin-bottom-2"
          ...
          <p class="hero ae-2 margin-bottom-3">
            <span class="opacity-8"
              >Doing Business Securily is Key to Success.</span
            >
          </p>
          <form
            action="#"
          ...
          >
            <button
              type="submit"
              class="button orange gradient ae-4"
              name="submit" style="text-wrap:balance;background-color: rgb(255, 140, 0);"
            >
              Request a Free Quote.
            </button>
            <p style="margin-top: 50px;text-wrap:balance;">
              Phone: +91 9008152084
              <br />
              Email: sales@cyberjeet.com
            </p>
          </form>
          <div class="wrap">
            <div
              class="fix-6-12"
              style="margin: 0 auto; padding: 20px; margin-top: 290px"
            >
              <!-- <h4><u>Contact Us</u></h4>
              <p fw-6>
                #401, Unit D1, 3rd Floor,
                Pentaken Tower, 28th Main Sec-1<br>
                HSR Layout - 560102<br>
                INDIA <br>
                Phone: +91 9008152084
                Email: info@aplearnings.com            
              </p>   -->
            </div>
          </div>
        </div>
      ...
      <div
        class="background"
        style="
          background-image: url(https://img.freepik.com/free-photo/abstract-techno-low-poly-background-with-dark-connecting-dots-lines_1048-6127.jpg?t=st=1709360208~exp=1709363808~hmac=be28dcf35dae36f3e7d6f86e9fc93cc9026a5f7ff740409d675f8b636646125c&w=740);
        "
      ></div>
    </section>
    ...
    <nav class="panel bottom lastSlideOnly">
      <div class="sections desktop">
        <div class="left">
          <!-- <a href="#" class="button hollow"
            ...
            <div class="right">
                <ul class="menu crop">
                    <li>
                        <a href="http://facebook.com/designmodo" target="_blank"><svg>
                  <use
                  ...
                  ></use></svg></a>
                    ...
                    <li>
                        <a href="http://twitter.com/designmodo" target="_blank"><svg>
                  <use
                    xmlns:xlink="http://www.w3.org/1999/xlink"
                    xlink:href="#twitter"
                  ></use></svg></a>
                    ...
                    <li>
                        <a href="http://instagram.com/designmodo" target="_blank"><svg>
                  <use
                    xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <div class="sections compact hidden">
            <div class="left">
                <a href="#" title="Slides Framework"><svg style="width: 82px; height: 24px">
              <use
                xmlns:xlink="http://www.w3.org/1999/xlink"
                xlink:href="#logo"
              ></use></svg></a>
